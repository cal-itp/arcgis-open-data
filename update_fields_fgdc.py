...
def grab_data_dictionary_for_dataset(
    dataset_name: str, data_dict_file: Union[str, Path] = DATA_DICT_YML
) -> dict:
    """
...
def populate_default_esri_columns(new_field_metadata: dict) -> list:
    """
...
def populate_other_dataset_columns(new_field_metadata: dict) -> dict:
    """
