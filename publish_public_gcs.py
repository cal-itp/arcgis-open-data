...
def construct_data_path(filename: str, date: str) -> str:
    """
...
def write_to_public_gcs(filename: str, date: str) -> str:
    """
    ...
    public_filename = f"{original_path_obj.stem}_{date}.zip"
    ...
    utils.make_zipped_shapefile(gdf, local_path=public_filename, gcs_folder=None)

    # Upload to GCS
    fs.put(public_filename, public_path)
